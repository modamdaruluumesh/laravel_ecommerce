...
<head>
    ...
    <style>
        .navbar-dropdown {
            ...
            /* Optional: match dark theme */
            box-shadow: 0 0 15px rgba(0, 0, 0, 0.1);
        }

        .dropdown-menu .dropdown-item {
            color: white;
            /* Match white text in dark theme */
        }
                ...
                <li class="nav-item menu-items">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="{{url('/view_products')}}">Add Products</a>
                            </li>
                            <li class="nav-item"> <a class="nav-link"
                                    href="{{'/show_products'}}">Show Products</a></li>
                    ...
                    <ul class="navbar-nav navbar-nav-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" id="userDropdown" href="#" data-toggle="dropdown"
                                aria-expanded="false">
                                <img src="{{ asset('admin/assets/images/faces/face15.jpg') }}"
